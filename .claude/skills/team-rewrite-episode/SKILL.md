...
Agent team episode rewrite pipeline. Editor + Proofreader parallel diagnosis, then Writer revision and Publisher post-processing.
...
→ `../team-write-episode/reference/actionlog-template.md` に従い ACTIONLOG を記録する。
記録先は `.claude/skills/team-rewrite-episode/reference/actions.jsonl`。
