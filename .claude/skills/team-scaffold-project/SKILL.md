...
- デザインドキュメントのパス
- プロジェクト名
- `scaffold-story-profile` スキルの内容（`.claude/skills/scaffold-story-profile/SKILL.md`）
...
- デザインドキュメントのパス
- プロジェクトパス
- `scaffold-characters` スキルの内容（`.claude/skills/scaffold-characters/SKILL.md`）
...
- デザインドキュメントのパス
- プロジェクトパス
- `scaffold-world` スキルの内容（`.claude/skills/scaffold-world/SKILL.md`）
...
- `scaffold-plot` スキルの内容（`.claude/skills/scaffold-plot/SKILL.md`）
...
- デザインドキュメントのパス
- プロジェクトパス
- `scaffold-foreshadowing` スキルの内容（`.claude/skills/scaffold-foreshadowing/SKILL.md`）
